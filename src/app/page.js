...
ใครจะคิดว่าเราจะได้รู้จักกันที่สนามแบดมินตันของมอ
วันนั้นเราไปเล่นแบดด้วย แล้วหยกมาเมคเฟรน เป็นจุดเริ่มต้นของมิตรภาพเรา 🏸
😊`,
        reveal: null
    },
    {
...
export default function BirthdayPage() {
                ...
                <div className="page-stage-wrapper pre-quiz-wrapper animate__animated animate__fadeIn">
                    <div className="pre-quiz-content-box animate__animated animate__zoomIn">
                        ...
                        <p className="pre-quiz-subtext">
                            (แต่ไม่ต้องกังวลไปนะ มันสนุกแน่ๆ อิอิ 😉)
                        </p>
                        <button
    ...
    return (
        <>
            <Head>
                <title>สุขสันต์วันเกิดนะ {FRIEND_NAME}!</title>
